...
import img from "../assets/other-svg/404.svg"
    ...
    return (
        <>
            ...
            <div id="error-page" className="flex flex-col items-center justify-center my-24 gap-3 space-y-4 w-11/12 mx-auto">
                ...
                <Link to="/" className="btn btn-neutral bg-brandRed-500 hover:bg-brandRed-500 border-none text-white normal-case font-medium text-lg">
